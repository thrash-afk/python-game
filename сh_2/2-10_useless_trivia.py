...
print("\nЕсли бы поэт Каммингс фдресовал тебе письмо, он бы обратился к тебе так:", name.lower())
...
print("А вот находясь на Солнце, вы бы весили", sun_weight, "кг. (Но, увы, не долго.)")
